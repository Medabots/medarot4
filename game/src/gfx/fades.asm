...
SECTION "Fade Variables 1", WRAM0[$C478]
W_PaletteAnimWaitCounter:: ds 1
W_PaletteAnimSlowdown:: ds 1

SECTION "Fade Variables 2", WRAM0[$C47B]
...
SECTION "Palette Fade Operations", ROM0[$1024]
