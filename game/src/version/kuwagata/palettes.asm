...
SECTION "BGP Palette Color Table A (Kuwagata)", ROMX[$4000], BANK[$2F]
...
SECTION "BGP Palette Color Table B (Kuwagata)", ROMX[$4000], BANK[$30]
...
SECTION "BGP Palette Group Table (Kuwagata)", ROMX[$4000], BANK[$31]
...
SECTION "OBP Palette Color Table (Kuwagata)", ROMX[$6800], BANK[$30]
...
SECTION "OBP Palette Group Table (Kuwagata)", ROMX[$7000], BANK[$31]
