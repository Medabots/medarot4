...
list_map = ({
    ...
    'Medarotters' : ([(0x29, 0x44D0)], 2, ["Unknown", "MedarotterName"], [None, 0xCB], [(3, 0x00), (None, None)], [True, False], None, None, True, None),
    'Medarotters2' : ([(0x2B, 0x4630)], 2, ["Unknown", "MedarotterName"], [None, 0xCB], [(3, 0x00), (None, None)], [True, False], None, None, True, None),
